(function () {
  try {
    ...
    ui.cameraHeadingValue.textContent = `${ui.cameraHeading.value}Â°`;
    ui.cameraPitchValue.textContent = `${ui.cameraPitch.value}Â°`;
    ...
    ui.cameraHeadingValue.textContent = `${headingWrapped}Â°`;
    ui.cameraPitch.value = String(clampedPitch);
    ui.cameraPitchValue.textContent = `${clampedPitch}Â°`;
  }
